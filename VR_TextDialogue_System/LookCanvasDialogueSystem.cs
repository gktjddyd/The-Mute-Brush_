...
[System.Serializable]
public class DialogueLoop2 {
    [TextArea]
    public string dialogue2;
}

public class LookCanvasDialogueSystem : MonoBehaviour
{
    [SerializeField] private TextMeshProUGUI txt_Dialogue;
    [SerializeField] private DialogueLoop2[] dialogue;
    ...
    public void NextDialogue()
    {
        ...
        {
            string dialogueText = dialogue[count].dialogue2;
            count++;
